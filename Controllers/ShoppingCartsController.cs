...
namespace BOOKSTORE.Controllers
{
    ...
    public class ShoppingCartsController : ControllerBase
    {
        ...
        {
            var entity = await _context.ShoppingCarts.FindAsync(id);
        ...
        [HttpPost]
        public async Task<ActionResult<ShoppingCart>> Create(ShoppingCart entity)
        {
        ...
        [Authorize(Roles = "Admin")]
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, ShoppingCart entity)
        {
